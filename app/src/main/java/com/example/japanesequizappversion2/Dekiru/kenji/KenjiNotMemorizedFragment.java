...
public class KenjiNotMemorizedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_kenji_not_memorized, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (DekiruManager.mListKanjiNotMemorized != null && DekiruManager.mListKanjiNotMemorized.size() != 0) {
            for (Pair<String, Kanji> kanji : DekiruManager.mListKanjiNotMemorized) {
        ...
        view.findViewById(R.id.btnClear).setOnClickListener(v -> {
            mDekiruManager.clearKanjiNotMemorized();
            mListName.clear();
