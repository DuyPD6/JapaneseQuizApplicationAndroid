...
public class WordNotMemorizedFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (DekiruManager.mListWordNotMemorized != null && DekiruManager.mListWordNotMemorized.size() != 0) {
            for (Pair<String, Word> word : DekiruManager.mListWordNotMemorized) {
        ...
        view.findViewById(R.id.btnClear).setOnClickListener(v -> {
            mDekiruManager.clearWordNotMemorized();
            mListName.clear();
