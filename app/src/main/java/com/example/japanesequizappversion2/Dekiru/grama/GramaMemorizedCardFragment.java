...
public class GramaMemorizedCardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_grama_memorized_card, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        for (Grama grama : DekiruManager.mListGramaMemorized) {
        ...
        view.findViewById(R.id.btnClear).setOnClickListener(v -> {
            mDekiruManager.clearGramaMemorized();
            mListName.clear();
